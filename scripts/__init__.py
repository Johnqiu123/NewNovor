#!/usr/bin/env python
'''
Scripts for functions common to multiple programming assignments for Bioinformatics Algortihms on Coursera.
'''
...
from Protein_Dictionaries import ProteinDictDNA, ProteinDictRNA,ProteinWeightDict, IntegerProteinWeightDict,IonTypeDict
